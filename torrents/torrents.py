...
#             {"listen_interfaces": "0.0.0.0:6881", "user_agent": "Gosti_Client"}
#         )
...
#         t.add_tracker("http://data.gosti.club:8000/announce")
#         t.set_creator("libtorrent (Gosti) %s" % libtorrent.__version__)
